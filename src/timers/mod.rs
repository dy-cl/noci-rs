...
macro_rules! for_each_counter {
    ($tot:ident, $f:ident) => {
        ...
        $f!($tot.stochastic.step.initialise_populations);
        $f!($tot.stochastic.step.sample_populations);
        $f!($tot.stochastic.step.generate_population_changes);
        $f!($tot.stochastic.step.acc_pack_updates);
        $f!($tot.stochastic.step.exchange_population_changes);
        $f!($tot.stochastic.step.exchange_population_change_counts);
        $f!($tot.stochastic.step.exchange_population_change_payload);
        $f!($tot.stochastic.step.unpack_population_changes);
        $f!($tot.stochastic.step.take_population_changes);
        $f!($tot.stochastic.step.apply_overlap_changes);
        $f!($tot.stochastic.step.overlap_change_gather_counts);
        $f!($tot.stochastic.step.apply_local_overlap_changes);
        $f!($tot.stochastic.step.wait_overlap_change_gather);
        $f!($tot.stochastic.step.apply_remote_overlap_changes);
        $f!($tot.stochastic.step.gather_all_populations);
        ...
        $f!($tot.nonorthogonalwicks.lg_overlap);
        $f!($tot.nonorthogonalwicks.lg_overlap_m0);
        $f!($tot.nonorthogonalwicks.lg_overlap_m0_l1);
        $f!($tot.nonorthogonalwicks.lg_overlap_m0_l2);
        $f!($tot.nonorthogonalwicks.lg_overlap_m0_l3);
        $f!($tot.nonorthogonalwicks.lg_overlap_m0_l4);
        $f!($tot.nonorthogonalwicks.lg_overlap_ml);
        $f!($tot.nonorthogonalwicks.lg_overlap_ml_l1);
        $f!($tot.nonorthogonalwicks.lg_overlap_ml_l2);
        $f!($tot.nonorthogonalwicks.lg_overlap_ml_l3);
        $f!($tot.nonorthogonalwicks.lg_overlap_gen);
        ...
        $f!($tot.nonorthogonalwicks.lg_one_body_m0_l3);
        ...
        $f!($tot.nonorthogonalwicks.lg_h2_diff_m0_12);
        $f!($tot.nonorthogonalwicks.lg_h2_diff_m0_21);
        $f!($tot.nonorthogonalwicks.lg_h2_diff_m0_22);
        $f!($tot.nonorthogonalwicks.lg_h2_same_m0_l3);
        $f!($tot.nonorthogonalwicks.lg_h2_same_m0_l4);
