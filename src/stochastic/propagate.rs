...
use super::state::{
    ...
    PropagationResult, PropagationState, QMCRunInfo, ScratchSize, Shifts, ThreadPropagation,
};
...
use super::report::{check_stop, print_cached_row, print_header, print_initial_row, print_row};
...
pub(crate) fn communicate_spawn_updates<'a>(
    ...
    time_call!(crate::timers::stochastic::add_communicate_spawn_updates, {
        ...
        scratch
            .recv_contig
            .resize(nrecv, PopulationUpdate { det: 0, dn: 0 });
...
pub(crate) fn gather_all_walkers<'a>(
    ...
    time_call!(crate::timers::stochastic::add_gather_all_walkers, {
        ...
        scratch
            .gather_recv
            .resize(ntot, PopulationUpdate { det: 0, dn: 0 });
...
fn update_observables(
    mc: &MCState,
    d: &[PopulationUpdate],
    pe: &mut ProjectedEnergyUpdate,
    isref: &[bool],
    run: &QMCRunInfo,
    data: &NOCIData<'_, f64>,
    world: &impl Communicator,
