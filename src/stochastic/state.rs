...
/// Report-block derivative of the pre-overlap change with respect to the SApply shift.
...
impl ShiftTangent {
    ...
    pub(in crate::stochastic) fn prepare(
        ...
        // Allocate N_det storage lazily because only SApply uses the worker shift tangent.
