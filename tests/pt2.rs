...
#[test]
#[serial]
fn pt2_h2_cc_pvdz_1_5_ang_energies() {
    let (_input, _ao, expected): (_, _, ExpectedPT2) = load_test("PT2_H2_cc-pVDZ_1_5");
    let (got_scf, got_ref, got_pt2) = run_pt2_fixture("PT2_H2_cc-pVDZ_1_5");
